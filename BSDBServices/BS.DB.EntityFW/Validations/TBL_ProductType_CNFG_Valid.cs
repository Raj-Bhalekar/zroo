...
{
    public partial class TBL_ProductType_CNFG : BSEntityInterface
    {
        public List<System.Data.Entity.Validation.DbValidationError> IsValid()
        {
            ...
            {
                errList.Add(new System.Data.Entity.Validation.DbValidationError("ProductTypeName", "Product Type Name " + ValidationMsg.IsRequired));
            }
            return errList;
        }
    }
